...
var GenericNumber = /** @class */ (function () {
    function GenericNumber(num1, num2) {
        this.num1 = num1;
        this.num2 = num2;
    }
    GenericNumber.prototype.initialiseSumToZero = function () {
        this.sum = 0;
    };
    GenericNumber.prototype.addTwoNumbers = function () {
...
var shape = function () {
    ...
    var _classThis;
    var shape = _classThis = /** @class */ (function () {
        function shape_1() {
        }
        return shape_1;
    }());
    __setFunctionName(_classThis, "shape");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        shape = _classThis = _classDescriptor.value;
...
function asynFunc() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, promiseExample()];
